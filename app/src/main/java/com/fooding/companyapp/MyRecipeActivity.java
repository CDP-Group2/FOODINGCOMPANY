...
import com.fooding.companyapp.activity.MakeRecipeActivity;
import com.fooding.companyapp.activity.MyPageActivity;
import com.fooding.companyapp.activity.ViewRecipeActivity;
...
//    @BindView(R.id.companyName) TextView companyNameText;
    ...
    ListView recipeList;
    @BindView(R.id.viewRecipeList)
    Button viewRecipeList;
...
//        companyNameText.setText(user.getName());
        ...
        viewRecipeList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MyRecipeActivity.this, ViewRecipeActivity.class));
//                finish();
            }
        });
        ...
        addRecipe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MyRecipeActivity.this, MakeRecipeActivity.class));
//                finish();
            }
        });
    }
