...
public interface APIService {
    ...
    Call<ResponseBody> makeRecipe(@Query("companyID") String companyID, @Query("recipeName") String recipeName, @Query("ingredientList[]") ArrayList<String> ingredientList, @Query("ingredientAmountList[]") ArrayList<Integer> ingredientAmountList);
